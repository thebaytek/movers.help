...
export function FinalCTA() {
  return (
    <section className="relative py-28 px-4 overflow-hidden bg-[#08080e]">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-px bg-gradient-to-r from-transparent via-accent-500/20 to-transparent" />
      </div>
      ...
      <div className="max-w-2xl mx-auto relative">
        <div className="relative glass-elevated rounded-3xl p-10 sm:p-14 text-center overflow-hidden">
          <motion.div
            ...
            className="absolute -top-40 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-accent-400/20 via-accent-500/10 to-transparent blur-3xl pointer-events-none"
          />

          <h2 className="relative text-4xl sm:text-5xl font-display font-bold gradient-text mb-4">
            Ready to Move?
          </h2>
          <p className="relative text-surface-400 text-lg max-w-md mx-auto text-balance mb-8">
          ...
          <div className="absolute -bottom-1 left-0 right-0 h-px bg-gradient-to-r from-transparent via-accent-500/30 to-transparent" />
        </div>
      </div>
    </section>
  );
